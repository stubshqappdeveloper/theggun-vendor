...
class AddProductNextScreenState extends State<AddProductNextScreen> {
  ...
  Future<void> _load() async {
    ...
    Provider.of<AddProductController>(Get.context!, listen: false).generateVariantTypes(Get.context!, widget.product);
  ...
  _asyncMethod() async {
    Future.delayed(const Duration(milliseconds: 800), () async {
      Provider.of<AddProductController>(Get.context!,listen: false).getProductImage(widget.product!.id.toString(), isStorePreviousImage: true);
    });
  }
                  ...
                  if(addColor==0) {
                    ...
                    if ( widget.product!.colors != null && widget.product!.colors!.isNotEmpty) {
                      Future.delayed(Duration.zero, () async {
                        Provider.of<AddProductController>(Get.context!, listen: false).setAttribute();
                      });
                    }
                    for (int index = 0; index < widget.product!.colors!.length; index++) {
                      colors.add(index);
                      Future.delayed(Duration.zero, () async {
                        resProvider.addVariant(Get.context!, 0, widget.product!.colors![index].name, widget.product, false);
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Column(children: [
                            ...
                            SizedBox(height: (resProvider.attributeList![0].variants.isNotEmpty) ? Dimensions.paddingSizeSmall : 0),

                            if(resProvider.attributeList?[0].active ?? false) Padding(
                              padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                                ...
                                childrens: [
                                  ...
                                  Padding(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      const SizedBox(height: Dimensions.paddingSizeSmall),
                                      Text(getTranslated('file_type', context)!, style: robotoRegular,),
                                                      ...
                                                      Expanded(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            child: DottedBorder(
                                                              ...
                                                              color: resProvider.variationFileList[index][i].fileName == null ? Theme.of(context).hintColor : Theme.of(context).primaryColor,
                                                              ...
                                                              child: InkWell(
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  child: Column(mainAxisAlignment: resProvider.variationFileList[index][i].fileName == null ? MainAxisAlignment.center : MainAxisAlignment.spaceBetween,
                                                                    children: resProvider.variationFileList[index][i].fileName == null ? [
                                                                      ...
                                                                      Expanded(child: Text(resProvider.variationFileList[index][i].fileName ?? '', style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeDefault), overflow: TextOverflow.ellipsis)),
                                                                      //deleteIcon
                                                                    ],
                                                                  ),
