                                    ...
                                    child: DropdownButton<int>(
                                      ...
                                      items: brandIds.map((int? value) {
                                        return DropdownMenuItem<int>(
                                          ...
                                          child: Text(
                                            value != 0 ? resProvider.brandList![(brandIds.indexOf(value)-1)].name! : getTranslated('select_brand', context)!,
                              ...
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                DropdownDecoratorWidget(
                                  ...
                                  child: DropdownButton<String>(
                                    icon: const Icon(Icons.keyboard_arrow_down_outlined),
                                    borderRadius: const BorderRadius.all(Radius.circular(Dimensions.paddingEye)),
                                    value: resProvider.digitalProductTypeIndex == 0 ? 'ready_after_sell' : 'ready_product',
                                    ...
                                    onChanged: (value) {
                                      resProvider.setDigitalProductTypeIndex(value == 'ready_after_sell' ? 0 : 1, true);
                                    },
                                    isExpanded: true,
                                    underline: const SizedBox(),
                                  ),
