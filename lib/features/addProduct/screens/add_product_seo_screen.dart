                                        ...
                                        child: InkWell(
                                          ...
                                          child: DottedBorder(
                                            ...
                                            child: Container(
                                              ...
                                              child: (resProvider.pickedLogo == null && (_product!.thumbnailFullUrl?.path == null || _product!.thumbnailFullUrl?.path == '')) ?
                                      ...
                                      Padding(
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: resProvider.pickedMeta != null ? Image.file(
                                            File(resProvider.pickedMeta!.path), width: 150, height: 160, fit: BoxFit.cover,
                                          ) : widget.product != null ? FadeInImage.assetNetwork(
                                            placeholder: Images.placeholderImage,
                                        ...
                                        child: InkWell(
                                          ...
                                          child: DottedBorder(
                                            ...
                                            child: Container(
                                              width: double.infinity,
                                              decoration: BoxDecoration(
                                                color: resProvider.pickedMeta != null ? Colors.black.withValues(alpha: 0.5) : null,
                                                borderRadius: BorderRadius.circular(Dimensions.paddingSizeSmall),
                                              ),
                                              child: (resProvider.pickedMeta == null && (_product!.metaSeoInfo?.imageFullUrl?.path == null || _product!.metaSeoInfo?.imageFullUrl?.path == '')) ?
                                              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                Image.asset(Images.uploadImageIcon, width: 40,),
                                            ...
                                            itemBuilder: (BuildContext context, index){
                                              return Stack(children: [
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: ClipRRect(
                                                      ...
                                                      child: CustomImageWidget(
                                                        image: resProvider.imagesWithoutColor[index],
                                                        width: MediaQuery.of(context).size.width/2.3,
                                                        height: MediaQuery.of(context).size.width/2.3,
                                                        fit: BoxFit.cover,
                                                      ),
                                                ...
                                                Positioned(top: 5, right : 5, child: InkWell(
                                                  splashColor: Colors.transparent,
                                                  onTap : () => resProvider.deleteProductImage(
                                                    '${_product?.id}',
                                                    _getFilenameFromFullImagePath(resProvider.imagesWithoutColor[index]),
                                                    null,
                                                  ),
                                                  child: Container(
                                                    decoration: BoxDecoration(
                                  ...
                                  if ((!_update && resProvider.pickedLogo == null) || (_update && (resProvider.pickedLogo == null  && (widget.product?.thumbnailFullUrl?.path == null || widget.product?.thumbnailFullUrl?.path == ''))) ) {
                                    ...
                                    if(_update){
                                      ...
                                      if(resProvider.pickedMeta != null){
                                        await resProvider.addProductImage(Get.context!, resProvider.metaImage, route, update: _update);

                                      }

                                      if(context.mounted) {
                                       await resProvider.onUploadColorImages(
                                         context: context,
                                         isUpdate: _update,
                                      ...
                                      if(resProvider.withoutColor.isNotEmpty){
                                        for(int i =0; i<resProvider.withoutColor.length; i++) {
                                          if(resProvider.withoutColor[i].image != null){
                                            await resProvider.addProductImage(Get.context!, resProvider.withoutColor[i], route, index: i, update: _update);
                                          }
                                      ...
                                      if(resProvider.pickedMeta != null){
                                       await resProvider.addProductImage(Get.context!, resProvider.metaImage,route);
                                      }


                                      if(resProvider.withColor.isNotEmpty){
                                        for(int i =0; i<resProvider.withColor.length; i++) {
                                         await resProvider.addProductImage(Get.context!, resProvider.withColor[i], route);
                                        }
                                      }

                                      if(resProvider.withoutColor.isNotEmpty){
                                        for(int i =0; i<resProvider.withoutColor.length; i++) {
                                         await resProvider.addProductImage(Get.context!, resProvider.withoutColor[i], route);
