                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                          ...
                          Row(children: [
                            ...
                            Expanded(flex: 8,child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              CustomText(amount: widget.productModel!.clearanceSale!.discountAmount, isLocale: false,
                                title: widget.productModel!.clearanceSale!.discountType == 'percentage'? widget.productModel!.clearanceSale!.discountAmount.toString():'0',
                                amountValue: widget.productModel!.clearanceSale!.discountType == 'flat',isPercentage: widget.productModel!.clearanceSale!.discountType == 'percentage') :
